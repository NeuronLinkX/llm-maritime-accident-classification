...
// 3대분류(운항과실 / 취급 불량 및 결함 / 기타)와 그 세부항목 22종. [대분류] 뒤에 세부항목을 쉼표로
// 나열하고, 대분류 사이는 "/"로 구분한다. 항목 이름 안의 접속 표현은 쉼표(항목 구분자)와 구분하기
// 위해 가운뎃점(·)으로 적는다(예: "선체·기관설비 결함").
const CANDIDATE_LABELS = "[운항과실] 출항준비 불량, 수로조사 불충분, 침로의 선정·유지불량, 선위확인 소홀, "
    . "조선 부적절, 경계소홀, 황천대비·대응 불량, 묘박·계류의 부적절, 항행법규 위반, 복무감독 소홀, "
    . "당직근무 태만, 운항과실 기타, 선내작업안전수칙 미준수 / "
    . "[취급 불량 및 결함] 선체·기관설비 결함, 기관설비 취급 불량, 화기취급 불량·전선노후·합선 / "
    . "[기타] 여객·화물의 적재 불량, 선박운항관리 부적절, 승무원 배승 부적절, 항해원조시설 등의 부적절, "
    . "기상 등 불가항력, 기타";
...
function build_prompt(array $clusterBlocks): array {
    ...
    $userPrompt = "다음은 한국 해양안전심판원 재결서를 SBERT 임베딩 + K-Means로 군집화한 결과입니다. "
        ...
        . "대분류 3종 아래 세부항목으로 구성)에서 가장 적절한 세부항목 하나를 고르거나"
        . "(꼭 후보 안에서만 고를 필요는 없음, 더 적절한 라벨이 있으면 새로 제안) "
        . "그 근거를 한국어 2문장 이내로 설명해 주세요.\n\n"
        . "사고원인 후보([대분류] 세부항목1, 세부항목2, ... 형식): " . CANDIDATE_LABELS . "\n\n"
